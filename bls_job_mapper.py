...
def calculate_ai_risk_from_category(job_category: str, occupation_code: Optional[str] = None) -> Dict[str, Any]:
    ...
    category_profiles = {
        "Computer and Mathematical Occupations": {"base": 30, "increase": 8, "variance": 7, "risk_factors": ["AI code generation", "Automated testing", "Data analysis automation"], "protective_factors": ["Complex system design", "Novel algorithm development", "Strategic tech leadership"]},
        "Management Occupations": {"base": 15, "increase": 4, "variance": 3, "risk_factors": ["Automated reporting", "AI scheduling tools", "Data-driven decision support"], "protective_factors": ["Strategic leadership", "Complex stakeholder management", "Team motivation and development"]},
        "Business and Financial Operations Occupations": {"base": 35, "increase": 7, "variance": 6, "risk_factors": ["Automated financial analysis", "Robotic Process Automation (RPA)", "AI fraud detection"], "protective_factors": ["Complex financial strategy", "Regulatory interpretation", "Client advisory"]},
        "Architecture and Engineering Occupations": {"base": 20, "increase": 6, "variance": 5, "risk_factors": ["AI-assisted design (CAD)", "Simulation software", "Automated compliance checks"], "protective_factors": ["Innovative design thinking", "Complex project oversight", "Solving novel engineering problems"]},
        "Life, Physical, and Social Science Occupations": {"base": 10, "increase": 5, "variance": 4, "risk_factors": ["Automated lab analysis", "AI data interpretation", "Research process automation"], "protective_factors": ["Formulating new hypotheses", "Complex experimental design", "Interdisciplinary research"]},
        "Community and Social Service Occupations": {"base": 10, "increase": 3, "variance": 3, "risk_factors": ["Automated case management tasks", "AI-powered resource matching", "Chatbots for initial contact"], "protective_factors": ["Empathy and human connection", "Complex crisis intervention", "Nuanced cultural understanding"]},
        "Legal Occupations": {"base": 25, "increase": 7, "variance": 6, "risk_factors": ["AI document review (e-discovery)", "Automated contract analysis", "Legal research AI tools"], "protective_factors": ["Courtroom advocacy", "Complex legal strategy", "Negotiation skills"]},
        "Educational Instruction and Library Occupations": {"base": 15, "increase": 4, "variance": 4, "risk_factors": ["AI tutoring systems", "Automated grading", "Online content delivery"], "protective_factors": ["Mentorship and inspiration", "Social-emotional development", "Adaptive teaching strategies"]},
        "Arts, Design, Entertainment, Sports, and Media Occupations": {"base": 25, "increase": 9, "variance": 8, "risk_factors": ["AI content generation (text, image, music)", "Automated video editing", "Personalized content recommendation"], "protective_factors": ["Original creativity and vision", "Live performance skills", "Cultural trendsetting"]},
        "Healthcare Practitioners and Technical Occupations": {"base": 10, "increase": 3, "variance": 3, "risk_factors": ["AI diagnostic assistance", "Robotic surgery tools", "Automated medical imaging analysis"], "protective_factors": ["Complex patient diagnosis", "Direct patient interaction and empathy", "Ethical medical judgment"]},
        "Healthcare Support Occupations": {"base": 20, "increase": 5, "variance": 4, "risk_factors": ["Automated patient scheduling", "AI-assisted medical coding", "Robotics in patient transport/care"], "protective_factors": ["Direct patient comfort and care", "Assisting with mobility", "Observing patient changes"]},
        "Protective Service Occupations": {"base": 15, "increase": 3, "variance": 3, "risk_factors": ["AI surveillance systems", "Predictive policing algorithms (controversial)", "Drone technology"], "protective_factors": ["On-the-ground judgment in dynamic situations", "Community interaction", "De-escalation skills"]},
        "Food Preparation and Serving Related Occupations": {"base": 45, "increase": 6, "variance": 7, "risk_factors": ["Automated food preparation robots", "Self-service kiosks", "AI-powered order taking"], "protective_factors": ["High-end culinary creativity", "Customer service and ambiance", "Adapting to custom orders"]},
        "Building and Grounds Cleaning and Maintenance Occupations": {"base": 40, "increase": 4, "variance": 5, "risk_factors": ["Robotic cleaning devices", "Automated lawn care", "Smart building maintenance sensors"], "protective_factors": ["Handling unexpected cleaning needs", "Detailed repair work", "Operating in varied environments"]},
        "Personal Care and Service Occupations": {"base": 20, "increase": 5, "variance": 5, "risk_factors": ["AI scheduling for appointments", "Virtual try-ons (e.g., hairstyles)", "Automated customer interaction for basic queries"], "protective_factors": ["Personalized human touch and interaction", "Skill in physical services (e.g., hairstyling)", "Building client rapport"]},
        "Sales and Related Occupations": {"base": 50, "increase": 8, "variance": 7, "risk_factors": ["E-commerce and online sales platforms", "AI-powered recommendation engines", "Automated checkout systems"], "protective_factors": ["Complex B2B sales negotiations", "High-value relationship selling", "Consultative sales approaches"]},
        "Office and Administrative Support Occupations": {"base": 60, "increase": 7, "variance": 5, "risk_factors": ["RPA for data entry and processing", "AI chatbots for customer inquiries", "Automated scheduling and document management"], "protective_factors": ["Complex office management", "Handling non-standard requests", "Executive-level support requiring discretion"]},
        "Farming, Fishing, and Forestry Occupations": {"base": 25, "increase": 4, "variance": 6, "risk_factors": ["Automated harvesting machinery", "Drones for crop monitoring", "AI for optimizing yields"], "protective_factors": ["Adapting to unpredictable natural conditions", "Specialized animal husbandry", "Sustainable farming practices requiring judgment"]},
        "Construction and Extraction Occupations": {"base": 30, "increase": 5, "variance": 6, "risk_factors": ["Robotics in bricklaying, welding", "Automated site surveying (drones)", "Prefabrication and modular construction"], "protective_factors": ["Skilled trades requiring dexterity and problem-solving on site", "Operating heavy machinery in complex environments", "Custom construction work"]},
        "Installation, Maintenance, and Repair Occupations": {"base": 25, "increase": 4, "variance": 5, "risk_factors": ["AI diagnostics for troubleshooting", "Predictive maintenance sensors", "Robots for routine inspections"], "protective_factors": ["Complex non-routine repairs", "Hands-on problem-solving", "Adapting to varied equipment and situations"]},
        "Production Occupations": {"base": 55, "increase": 6, "variance": 6, "risk_factors": ["Advanced robotics in assembly lines", "AI for quality control", "Automated material handling"], "protective_factors": ["Overseeing automated systems", "Complex machine setup and maintenance", "Custom or small-batch production"]},
        "Transportation and Material Moving Occupations": {"base": 50, "increase": 9, "variance": 8, "risk_factors": ["Autonomous vehicles (trucks, delivery drones)", "AI-powered logistics and route optimization", "Automated warehouse systems"], "protective_factors": ["Last-mile delivery complexities", "Handling irregular cargo or situations", "Passenger interaction in public transport (for now)"]},
        "General": {"base": 35, "increase": 7, "variance": 6, "risk_factors": ["Routine task automation", "Data processing", "Predictable physical work"], "protective_factors": ["Complex problem-solving", "Creativity", "Interpersonal skills"]}
    }
    profile = category_profiles.get(job_category, category_profiles["General"])
